...
public class GeneralProductTest {
    ...
    void should_return_correct_quality_when_pass_several_days_given_gilded_rose_include_general_product_in_sell_in_period(int passedDays, int expectedQuality) {
    ...
    void should_return_correct_quality_when_pass_several_days_given_gilded_rose_include_expired_general_product(int passedDays, int expectedQuality) {
        List<GeneralProduct> generalProducts = new ArrayList<>();
    ...
    @Test
    void should_return_correct_quality_when_product_from_not_expired_to_expired_given_gilded_rose_include_general_product() {
        List<GeneralProduct> generalProducts = new ArrayList<>();
    ...
    @Test
    void should_return_0_quality_when_product_pass_12_days_given_gilded_rose_include_general_product_with_10_quality_and_15_sell_in() {
        List<GeneralProduct> generalProducts = new ArrayList<>();
    ...
    @Test
    void should_return_0_quality_when_pass_8_days_given_gilded_rose_include_general_product_with_10_quality_and_5_sell_in() {
        List<GeneralProduct> generalProducts = new ArrayList<>();
        GeneralProduct generalProduct = new GeneralProduct(5, 10);
        generalProducts.add(generalProduct);
        GildedRose gildedRose = new GildedRose(generalProducts, new ArrayList<>());
